...
- Every detector class exposes exactly `Load(...)` and `Evaluate(const MqlRates &rates[], ...)` — tests only ever call `Evaluate`. (`.claude/skills/candles-and-series/SKILL.md`, function ownership; `docs/superpowers/specs/2026-08-08-4points-fase1-nucleo-tests-design.md`)
